...
# Create a Jan (within bolt-cpp-ml) Extension using Typescript
...
- Most Jan (within bolt-cpp-ml) Extension functions are processed asynchronously.
  ...
  For more information about the Jan (within bolt-cpp-ml) Extension Core module, see the
  [documentation](https://github.com/jan (within bolt-cpp-ml)hq/jan (within bolt-cpp-ml)/blob/main/core/README.md).
